...
class TestStatement(unittest.TestCase):
    ...
    def test_base(self):
        ...
        # Testing final state
        dfa = statement.dfa_from_string(string_a, string_target, string_b, zero_states, found_states, appendedAll_state, accept_state)
        latest_state = statement.run_dfa(dfa, file_string, zero_states, found_states, appendedAll_state, accept_state, error_state, Secret_str_between)
