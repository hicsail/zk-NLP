import sys
from miniwizpl import SecretStack, SecretList, mux, public_foreach_prev, public_foreach, public_foreach_unroll, print_emp
...
def run_dfa(dfa, text_input):
    ...
    loop=public_foreach_prev(text_input, next_state_fun, zero_state)
