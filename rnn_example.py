...
def init_model_for_emp(model, input_str):
    model.eval() # eval mode
    input_str = input_str.lower()
    characters = [_ for _ in input_str]
...
text = ['hey how are you','good i am fine','have a nice day', 'thanks you too', 'catch you later', 'see ya']
